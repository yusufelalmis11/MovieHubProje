...
class animasyonkategorisayfasi extends StatefulWidget {
  const animasyonkategorisayfasi({Key? key}) : super(key: key);

  @override
  State<animasyonkategorisayfasi> createState() =>
      _animasyonkategorisayfasiState();
}

class _animasyonkategorisayfasiState extends State<animasyonkategorisayfasi> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: FutureBuilder<QuerySnapshot>(
          future: filmlerRef.where("tur", isEqualTo: "Animasyon").get(),
