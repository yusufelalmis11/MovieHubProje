...
class aksiyonkategorisayfasi extends StatefulWidget {
  const aksiyonkategorisayfasi({Key? key}) : super(key: key);

  @override
  State<aksiyonkategorisayfasi> createState() => _aksiyonkategorisayfasiState();
}

class _aksiyonkategorisayfasiState extends State<aksiyonkategorisayfasi> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: FutureBuilder<QuerySnapshot>(
          future: filmlerRef.where("tur", isEqualTo: "Aksiyon").get(),
