...
class romantikkategorisayfasi extends StatefulWidget {
  const romantikkategorisayfasi({Key? key}) : super(key: key);

  @override
  State<romantikkategorisayfasi> createState() =>
      _romantikkategorisayfasiState();
}

class _romantikkategorisayfasiState extends State<romantikkategorisayfasi> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: FutureBuilder<QuerySnapshot>(
          future: filmlerRef.where("tur", isEqualTo: "Romantik").get(),
